...
public class OfferRelease {
	...
	public OfferRelease(int formIdFourteen, String mailId, String name, String cv, Date dob, int contact,
	...
	public String toString() {
		return "OfferRelease [formIdFourteen=" + formIdFourteen + ", mailId=" + mailId + ", Name=" + Name + ", cv=" + cv
				+ ", dob=" + dob + ", contact=" + contact + ", registrationDate=" + registrationDate + ", approver="
				+ approver + ", confirmation=" + confirmation + ", reason=" + reason + ", decision=" + decision + "]";
	}
